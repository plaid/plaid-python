...
class Transaction(object):
    ...
    def payment_channel(self):
        ...
        The channel used to make a payment. Possible values are:  `online:` transactions that took place online.  `in store:` transactions that were made at a physical location.  `other:` transactions that relate to banks, e.g. fees or deposits.  This field replaces the `transaction_type` field.   # noqa: E501
    ...
    def category_id(self):
        ...
        The ID of the category to which this transaction belongs. See [Categories](https://plaid.com/docs/#category-overview).   If the `transaction` object was returned by an Assets endpoint such as `/assets/get/` or `/assets/pdf/get`, this field will only appear in an Asset Report with Insights.  # noqa: E501
    ...
    def category(self):
        ...
        A hierarchical array of the categories to which this transaction belongs. See [Categories](https://plaid.com/docs/#category-overview).   If the `transaction` object was returned by an Assets endpoint such as `/assets/get/` or `/assets/pdf/get`, this field will only appear in an Asset Report with Insights.  # noqa: E501
