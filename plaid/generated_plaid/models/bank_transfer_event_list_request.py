...
class BankTransferEventListRequest(object):
    ...
    def count(self):
        ...
        The maximum number of bank transfer events to return. Count should be in the range 1 to 25.  If a number out of range is provided, then you will receive an `INVALID_FIELD` error.   If the number of events matching the above parameters is greater than count, the most recent events will be returned.  # noqa: E501
