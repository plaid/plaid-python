...
class BankTransferEventListRequest(object):
    ...
    def __init__(self, client_id=None, secret=None, start_date=None, end_date=None, bank_transfer_id=None, account_id=None, bank_transfer_type=None, event_types=None, count=25, offset=None, origination_account_id=None, direction=None, local_vars_configuration=None):  # noqa: E501
    ...
    def count(self):
        ...
        The maximum number of bank transfer events to return. Count should be in the range 1 to 25.  If a number out of range is provided, then you will receive an `INVALID_FIELD` error. Default value if unspecified is 25.   If the number of events matching the above parameters is greater than `count`, the most recent events will be returned.  # noqa: E501
    ...
    def offset(self):
        ...
        The offset into the list of bank transfer events. When `count`=25 and `offset`=0, the first 25 events will be returned. When `count`=25 and `offset`=25, the next 25 bank transfer events will be returned. Default value if unspecified is 0.  # noqa: E501
