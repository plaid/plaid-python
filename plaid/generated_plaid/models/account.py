...
class Account(object):
    ...
    def __init__(self, account_id=None, balances=None, mask=None, name=None, official_name=None, type=None, subtype=None, verification_status=None, historical_balances=None, owners=None, days_available=None, transactions=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def mask(self):
        """Gets the mask of this Account.  # noqa: E501
        ...
        :return: The mask of this Account.  # noqa: E501
        :rtype: str
        """
        return self._mask
    ...
    @mask.setter
    def mask(self, mask):
        """Sets the mask of this Account.

        The last 2-4 alphanumeric characters of an account's official account number. Note that the mask may be non-unique between an Item's accounts, and it may also not match the mask that the bank displays to the user.  # noqa: E501

        :param mask: The mask of this Account.  # noqa: E501
        :type mask: str
        """
    ...
    def official_name(self):
        """Gets the official_name of this Account.  # noqa: E501

        The official name of the account as given by the financial institution  # noqa: E501

        :return: The official_name of this Account.  # noqa: E501
        :rtype: str
        """
    ...
    def official_name(self, official_name):
        """Sets the official_name of this Account.

        The official name of the account as given by the financial institution  # noqa: E501

        :param official_name: The official_name of this Account.  # noqa: E501
    ...
    def verification_status(self):
        """Gets the verification_status of this Account.  # noqa: E501
        ...
        :return: The verification_status of this Account.  # noqa: E501
        :rtype: str
        """
    ...
    def verification_status(self, verification_status):
        """Sets the verification_status of this Account.

        The current verification status of an Auth Item initiated through Automated or Manual micro-deposits.  Returned for Auth Items only. Possible values are:  `pending_automatic_verification`: The Item is pending automatic verification  `pending_manual_verification`: The Item is pending manual micro-deposit verification. Items remain in this state until the user successfully verifies the two amounts.  `automatically_verified`: The Item has successfully been automatically verified   `manually_verified`: The Item has successfully been manually verified  `verification_expired`: Plaid was unable to automatically verify the deposit within 7 calendar days and will no longer attempt to validate the Item. Users may retry by submitting their information again through Link.  `verification_failed`: The Item failed manual microdeposit verification because the user exhausted all 3 verification attempts. Users may retry by submitting their information again through Link.     # noqa: E501

        :param verification_status: The verification_status of this Account.  # noqa: E501
    ...
    def historical_balances(self):
        """Gets the historical_balances of this Account.  # noqa: E501

        Calculated data about the historical balances on the account. Only returned by Assets endpoints.  # noqa: E501

        :return: The historical_balances of this Account.  # noqa: E501
    ...
    def historical_balances(self, historical_balances):
        """Sets the historical_balances of this Account.

        Calculated data about the historical balances on the account. Only returned by Assets endpoints.  # noqa: E501

        :param historical_balances: The historical_balances of this Account.  # noqa: E501
    ...
    def days_available(self):
        """Gets the days_available of this Account.  # noqa: E501
        ...
        :return: The days_available of this Account.  # noqa: E501
        :rtype: float
        """
    ...
    def days_available(self, days_available):
        """Sets the days_available of this Account.

        The duration of transaction history available for this Item, typically defined as the time since the date of the earliest transaction in that account. Only returned by Assets endpoints.  # noqa: E501

        :param days_available: The days_available of this Account.  # noqa: E501
    ...
    def transactions(self):
        """Gets the transactions of this Account.  # noqa: E501
        ...
        :return: The transactions of this Account.  # noqa: E501
