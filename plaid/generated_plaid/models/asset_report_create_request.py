...
class AssetReportCreateRequest(object):
    ...
    def days_requested(self):
        ...
        The maximum number of days of history to include in the Asset Report. Must be an integer, with a minimum value of 0 and a maximum value of 730. If using Fannie Mae Day 1 Certainty, `days_requested` must be at least 61 for new originations or at least 31 for refinancings.  # noqa: E501
