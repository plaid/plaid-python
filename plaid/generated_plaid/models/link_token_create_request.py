...
class LinkTokenCreateRequest(object):
    ...
    def access_token(self):
        ...
        The `access_token` associated with the Item to update, used when updating or modifying an existing `access_token`. Used when launching Link in update mode or (optionally) when initializing Link as part of the Payment Initiation (UK) flow.  # noqa: E501
