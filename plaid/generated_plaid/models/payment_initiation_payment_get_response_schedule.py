...
class PaymentInitiationPaymentGetResponseSchedule(object):
    ...
    def __init__(self, interval=None, interval_execution_day=None, start_date=None, local_vars_configuration=None):  # noqa: E501
        """PaymentInitiationPaymentGetResponseSchedule - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def interval(self):
        """Gets the interval of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501

        The frequency interval of the payment.  # noqa: E501

        :return: The interval of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        :rtype: str
        """
    ...
    def interval(self, interval):
        """Sets the interval of this PaymentInitiationPaymentGetResponseSchedule.

        The frequency interval of the payment.  # noqa: E501

        :param interval: The interval of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        :type interval: str
        """
    ...
    def interval_execution_day(self):
        """Gets the interval_execution_day of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        ...
        :return: The interval_execution_day of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        :rtype: float
        """
    ...
    def interval_execution_day(self, interval_execution_day):
        """Sets the interval_execution_day of this PaymentInitiationPaymentGetResponseSchedule.

        The day of the interval on which to schedule the payment.  If the payment interval is weekly, `interval_execution_day` should be an integer from 1 (Monday) to 7 (Sunday).  If the payment interval is monthly, `interval_execution_day` should be an integer indicating which day of the month to make the payment on. Integers from 1 to 28 can be used to make a payment on that day of the month. Negative integers from -1 to -5 can be used to make a payment relative to the end of the month. To make a payment on the last day of the month, use -1; to make the payment on the second-to-last day, use -2, and so on.  # noqa: E501

        :param interval_execution_day: The interval_execution_day of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
    ...
    @property
    def start_date(self):
        """Gets the start_date of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        ...
        :return: The start_date of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        :rtype: str
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this PaymentInitiationPaymentGetResponseSchedule.

        A date in ISO 8601 format (YYYY-MM-DD). Standing order payments will begin on the first `interval_execution_day` on or after the `start_date`.  If the first `interval_execution_day` on or after the start date is also the same day that `/payment_initiation/payment/create` was called, the bank *may* make the first payment on that day, but it is not guaranteed to do so.  It is not possible to specify an end date for a standing order payment.  To end or modify a standing order payment, the end user should contact their bank.  # noqa: E501

        :param start_date: The start_date of this PaymentInitiationPaymentGetResponseSchedule.  # noqa: E501
        :type start_date: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentInitiationPaymentGetResponseSchedule):
            return False
