...
class ProductStatus(object):
    ...
    def status(self):
        ...
        One of the following three values: `HEALTHY`: the majority of requests are successful `DEGRADED`: only some requests are successful `DOWN`: all requests are failing  # noqa: E501
