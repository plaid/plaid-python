...
class StudentLoanStatus(object):
    ...
    def type(self):
        ...
        The status type of the student loan  # noqa: E501
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = [None,"cancelled", "charged off", "claim", "consolidated", "deferment", "delinquent", "discharged", "extension", "forbearance", "in grace", "in military", "in school", "not fully disbursed", "other", "paid in full", "refunded", "repayment", "transferred"]  # noqa: E501
