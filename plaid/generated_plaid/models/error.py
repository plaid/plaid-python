...
class Error(object):
    ...
    def error_type(self):
        ...
        A broad categorization of the error. Safe for programatic use.  Possible values: `INVALID_REQUEST`, `INVALID_INPUT`, `INSTITUTION_ERROR`, `RATE_LIMIT_EXCEEDED`, `API_ERROR`, `ITEM_ERROR`, `ASSET_REPORT_ERROR`, `RECAPTCHA_ERROR`, `OAUTH_ERROR`, `PAYMENT_ERROR`  # noqa: E501
