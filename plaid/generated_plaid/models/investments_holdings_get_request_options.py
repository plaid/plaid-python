...
class InvestmentsHoldingsGetRequestOptions(object):
    ...
    def __init__(self, account_ids=None, local_vars_configuration=None):  # noqa: E501
        """InvestmentsHoldingsGetRequestOptions - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_ids(self):
        """Gets the account_ids of this InvestmentsHoldingsGetRequestOptions.  # noqa: E501
        ...
        :return: The account_ids of this InvestmentsHoldingsGetRequestOptions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def account_ids(self, account_ids):
        """Sets the account_ids of this InvestmentsHoldingsGetRequestOptions.

        An array of `account_id`s to retrieve for the Item. An error will be returned if a provided `account_id` is not associated with the Item.  # noqa: E501

        :param account_ids: The account_ids of this InvestmentsHoldingsGetRequestOptions.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvestmentsHoldingsGetRequestOptions):
            return False
