...
class AssetReportRefreshRequest(object):
    ...
    def days_requested(self):
        ...
        The maximum number of days of history to include in the Asset Report. Must be an integer, with a minimum value of 0 and a maximum value of 730. If not specified, the value from the original call to `/asset_report/create` will be used.  # noqa: E501
