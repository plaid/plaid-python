...
class ProductStatusBreakdown(object):
    ...
    def refresh_interval(self):
        ...
        One of `NORMAL`, `DELAYED`, or `STOPPED`. The `refresh_interval` may be `DELAYED` or `STOPPED` even when the success rate is high.  This value is only returned for Transactions status breakdowns.  # noqa: E501
