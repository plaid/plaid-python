...
class PlaidApi(object):
    ...
    def create_payment_token(self, payment_initiation_payment_token_create_request, **kwargs):  # noqa: E501
        ...
        :param payment_initiation_payment_token_create_request: (required)
        :type payment_initiation_payment_token_create_request: PaymentInitiationPaymentTokenCreateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PaymentInitiationPaymentTokenCreateResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.create_payment_token_with_http_info(payment_initiation_payment_token_create_request, **kwargs)  # noqa: E501

    def create_payment_token_with_http_info(self, payment_initiation_payment_token_create_request, **kwargs):  # noqa: E501
        """Create payment token  # noqa: E501
        ...
        >>> thread = api.create_payment_token_with_http_info(payment_initiation_payment_token_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PaymentInitiationPaymentTokenCreateResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and ('payment_initiation_payment_token_create_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['payment_initiation_payment_token_create_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `payment_initiation_payment_token_create_request` when calling `create_payment_token`")  # noqa: E501
        ...
        body_params = None
        if 'payment_initiation_payment_token_create_request' in local_var_params:
            body_params = local_var_params['payment_initiation_payment_token_create_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaymentInitiationPaymentTokenCreateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def item_create_public_token(self, item_public_token_create_request, **kwargs):  # noqa: E501
        ...
        :param item_public_token_create_request: (required)
        :type item_public_token_create_request: ItemPublicTokenCreateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ItemPublicTokenCreateResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.item_create_public_token_with_http_info(item_public_token_create_request, **kwargs)  # noqa: E501

    def item_create_public_token_with_http_info(self, item_public_token_create_request, **kwargs):  # noqa: E501
        """Create public token  # noqa: E501
        ...
        >>> thread = api.item_create_public_token_with_http_info(item_public_token_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ItemPublicTokenCreateResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method item_create_public_token" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'item_public_token_create_request' is set
        if self.api_client.client_side_validation and ('item_public_token_create_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['item_public_token_create_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `item_public_token_create_request` when calling `item_create_public_token`")  # noqa: E501
        ...
        body_params = None
        if 'item_public_token_create_request' in local_var_params:
            body_params = local_var_params['item_public_token_create_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ItemPublicTokenCreateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
