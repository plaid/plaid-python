...
class PlaidApi(object):
    ...
    def bank_transfer_balance_get(self, bank_transfer_balance_get_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/balance/get` endpoint to see the available balance in your bank transfer account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def bank_transfer_cancel(self, bank_transfer_cancel_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/cancel` endpoint to cancel a bank transfer if it is still eligible for cancellation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def bank_transfer_event_list(self, bank_transfer_event_list_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/event/list` endpoint to get a list of bank transfer events based on some filter criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def bank_transfer_event_sync(self, bank_transfer_event_sync_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/event/sync` endpoint to guarantee you have seen all bank transfer events.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def bank_transfer_get(self, bank_transfer_get_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/get` endpoint to fetch information about the bank transfer corresponding to the given `bank_transfer_id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def bank_transfer_list(self, bank_transfer_list_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/list` endpoint to see a list of all your bank transfers and their statuses.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def bank_transfer_migrate_account(self, bank_transfer_migrate_account_request, **kwargs):  # noqa: E501
        ...
        Use the `/bank_transfer/migrate_account` endpoint to migrate known account and routing numbers to Plaid Items.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def item_webhook_update(self, item_webhook_update_request, **kwargs):  # noqa: E501
        ...
        The POST `/item/webhook/update` allows you to update the webhook URL associated with an Item. This request triggers a [`WEBHOOK_UPDATE_ACKNOWLEDGED`](/docs/webhooks/#item-webhook-url-updated) webhook to the newly specified webhook URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sandbox_bank_transfer_simulate(self, sandbox_bank_transfer_simulate_request, **kwargs):  # noqa: E501
        ...
        Use the `/sandbox/bank_transfer/simulate` endpoint to simulate a bank transfer event in the Sandbox environment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
