...
class DisconnectedApplication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, application_id, name, *args, **kwargs):  # noqa: E501
        """DisconnectedApplication - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_id, name, *args, **kwargs):  # noqa: E501
        """DisconnectedApplication - a model defined in OpenAPI
