...
class InvestmentsAuthGetResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, accounts, holdings, securities, owners, numbers, item, request_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, holdings, securities, owners, numbers, item, request_id, *args, **kwargs):  # noqa: E501
        """InvestmentsAuthGetResponse - a model defined in OpenAPI
