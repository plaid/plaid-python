...
def lazy_import():
    ...
    globals()['IncomeBreakdownType'] = IncomeBreakdownType
...
class IncomeBreakdown(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'type': (IncomeBreakdownType,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, rate, hours, total, *args, **kwargs):  # noqa: E501
