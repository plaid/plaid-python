...
class CreditBankStatementUploadBankAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, bank_name, account_type, account_number, owner, periods, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, bank_name, account_type, account_number, owner, periods, *args, **kwargs):  # noqa: E501
        """CreditBankStatementUploadBankAccount - a model defined in OpenAPI
