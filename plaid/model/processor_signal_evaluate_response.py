...
class ProcessorSignalEvaluateResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, scores, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            warnings ([SignalWarning]): If bank information was not available to be used in the Signal Transasction Scores model, this array contains warnings describing why bank data is missing. If you want to receive an API error instead of scores in the case of missing bank data, file a support ticket or contact your Plaid account manager.. [optional]  # noqa: E501
        """
