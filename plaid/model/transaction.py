...
class Transaction(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, transaction_id, account_owner, pending_transaction_id, pending, payment_channel, payment_meta, name, merchant_name, location, authorized_date, authorized_datetime, date, datetime, category_id, category, unofficial_currency_code, iso_currency_code, amount, account_id, transaction_code, *args, **kwargs):  # noqa: E501
