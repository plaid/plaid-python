...
class CraBaseReportCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_token, days_requested, webhook, consumer_report_permissible_purpose, *args, **kwargs):  # noqa: E501
        """CraBaseReportCreateRequest - a model defined in OpenAPI

        Args:
            user_token (str): The user token associated with the User data is being requested for.
            days_requested (int): The duration of transaction history you requested
            webhook (str, none_type): URL to which Plaid will send Assets webhooks, for example when the requested Asset Report is ready.
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_token, days_requested, webhook, consumer_report_permissible_purpose, *args, **kwargs):  # noqa: E501
        """CraBaseReportCreateRequest - a model defined in OpenAPI
