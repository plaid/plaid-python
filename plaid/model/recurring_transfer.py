...
class RecurringTransfer(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, recurring_transfer_id, created, next_origination_date, type, amount, status, network, origination_account_id, account_id, iso_currency_code, user, schedule, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            transfer_ids ([str]): [optional]  # noqa: E501
            decision (TransferAuthorizationDecision): [optional]  # noqa: E501
