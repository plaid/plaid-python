...
class DepositSwitchTargetAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_number, routing_number, account_name, account_subtype, *args, **kwargs):  # noqa: E501
        """DepositSwitchTargetAccount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_number, routing_number, account_name, account_subtype, *args, **kwargs):  # noqa: E501
        """DepositSwitchTargetAccount - a model defined in OpenAPI
