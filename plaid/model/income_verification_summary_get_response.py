...
class IncomeVerificationSummaryGetResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, income_summaries, request_id, *args, **kwargs):  # noqa: E501
        """IncomeVerificationSummaryGetResponse - a model defined in OpenAPI
        ...
        self.income_summaries = income_summaries
