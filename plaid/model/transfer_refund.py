...
class TransferRefund(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, transfer_id, amount, status, created, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, transfer_id, amount, status, created, *args, **kwargs):  # noqa: E501
        """TransferRefund - a model defined in OpenAPI
