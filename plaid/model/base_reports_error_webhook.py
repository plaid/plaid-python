...
class BaseReportsErrorWebhook(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, webhook_type, webhook_code, error, environment, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            asset_report_id (str): The ID associated with the Asset Report.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, webhook_type, webhook_code, error, environment, *args, **kwargs):  # noqa: E501
        """BaseReportsErrorWebhook - a model defined in OpenAPI
