...
class PaymentInitiationRecipientListResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, recipients, request_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            next_cursor (str): The value that, when used as the optional `cursor` parameter to `/payment_initiation/recipient/list`, will return the corresponding recipient as its first recipient.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, recipients, request_id, *args, **kwargs):  # noqa: E501
        """PaymentInitiationRecipientListResponse - a model defined in OpenAPI
