...
class TransactionStream(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'last_user_modified_date': (date,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'last_user_modified_date': 'last_user_modified_date',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, account_id, stream_id, category, category_id, description, merchant_name, first_date, last_date, frequency, transaction_ids, average_amount, last_amount, is_active, status, is_user_modified, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            is_user_modified (bool): This will be set to `true` if the stream has been modified by request to a `/transactions/recurring/streams` endpoint. It will be `false` for all other streams.
        ...
        Keyword Args:
            ...
            last_user_modified_date (date): The date of the most recent user modification. This will only be set if `is_user_modified` is `true`.. [optional]  # noqa: E501
        """
