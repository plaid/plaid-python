...
class PaymentStatusUpdateWebhook(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, webhook_type, webhook_code, payment_id, new_payment_status, old_payment_status, original_reference, original_start_date, adjusted_start_date, timestamp, *args, **kwargs):  # noqa: E501
