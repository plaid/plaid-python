...
class LinkTokenCreateRequestAccountSubtypes(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'depository': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'credit': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'loan': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'investment': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
