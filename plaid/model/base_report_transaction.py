...
class BaseReportTransaction(ModelNormal):
    ...
    def _from_openapi_data(cls, account_id, amount, iso_currency_code, unofficial_currency_code, original_description, date, pending, transaction_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            category_id (str): The ID of the category to which this transaction belongs. For a full list of categories, see [`/categories/get`](https://plaid.com/docs/api/products/transactions/#categoriesget).. [optional]  # noqa: E501
        """
