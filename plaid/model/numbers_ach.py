...
class NumbersACH(ModelNormal):
    ...
    def _from_openapi_data(cls, account_id, account, routing, wire_routing, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            account (str): The ACH account number for the account.  At certain institutions, including Chase, PNC, and US Bank, you will receive \"tokenized\" routing and account numbers, which are not the user's actual account and routing numbers. For important details on how this may impact your integration and on how to avoid fraud, user confusion, and ACH returns, see [Tokenized account numbers](https://plaid.com/docs/auth/#tokenized-account-numbers).
