...
class LinkEventsWebhook(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, webhook_type, webhook_code, events, link_session_id, link_token, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, webhook_type, webhook_code, events, link_session_id, link_token, *args, **kwargs):  # noqa: E501
        """LinkEventsWebhook - a model defined in OpenAPI
