...
class FDXNotification(ModelNormal):
    ...
    def _from_openapi_data(cls, notification_id, type, sent_on, category, notification_payload, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            sent_on (datetime): ISO 8601 date-time in format 'YYYY-MM-DDThh:mm:ss.nnn[Z|[+|-]hh:mm]' according to [IETF RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)
        ...
        Keyword Args:
            ...
            subtype (str): An optional initiator-defined event subtype code or description if the event type needs to be further categorized or described.. [optional]  # noqa: E501
