...
class InstitutionsGetRequestOptions(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            products ([Products], none_type): Filter the Institutions based on which products they support. Will only return institutions that support all listed products. When filtering based on `auth`, an institution must support Instant Auth to match the criterion. To filter for Signal support, use `balance`. To filter for Transfer support, use `auth`.. [optional]  # noqa: E501
