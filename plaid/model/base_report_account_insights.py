...
class BaseReportAccountInsights(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            longest_gaps_between_transactions ([BaseReportLongestGapInsights]): Customers must transition from `longest_gap_between_transactions` by October 31st 2024. Longest gap between sequential transactions in a time period. This array can include multiple time periods.. [optional]  # noqa: E501
            ...
            average_inflow_amounts ([BaseReportAverageFlowInsights]): Customers must transition from `average_inflow_amount` by October 31st 2024. Average amount of debit transactions into the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.. [optional]  # noqa: E501
