...
def lazy_import():
    ...
    globals()['TransferExpectedSettlementScheduleItem'] = TransferExpectedSettlementScheduleItem
...
class Transfer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'settled_amount': (str, none_type,),  # noqa: E501
            'expected_settlement_schedule': ([TransferExpectedSettlementScheduleItem],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'settled_amount': 'settled_amount',  # noqa: E501
        'expected_settlement_schedule': 'expected_settlement_schedule',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, id, funding_account_id, type, user, amount, description, created, status, network, cancellable, failure_reason, metadata, origination_account_id, guarantee_decision, guarantee_decision_rationale, iso_currency_code, standard_return_window, unauthorized_return_window, expected_settlement_date, originator_client_id, refunds, recurring_transfer_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            settled_amount (str, none_type): The accumulated amount that have been swept to date. This number does not reflect `return_swept` amount if the transfer is returned. Only applies to ACH debit transfers.. [optional]  # noqa: E501
            expected_settlement_schedule ([TransferExpectedSettlementScheduleItem]): The expected settlement schedule of this transfer, if posted. Only applies to ACH debit transfers.. [optional]  # noqa: E501
        """
