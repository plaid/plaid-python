...
class ExternalPaymentOptions(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            request_refund_details (bool, none_type): When true Plaid will attempt to request refund details from the payee's financal institution.  Support varies between financial institutions and will not always be available.  If we are able to request refund details the details will be available in the `/payment/get` response.. [optional]  # noqa: E501
