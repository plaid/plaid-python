...
class PrismInsights(ModelNormal):
    ...
    def _from_openapi_data(cls, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            result ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The Insights Result object is a map of cash flow attributes, in string to float format.. [optional]  # noqa: E501
        """
