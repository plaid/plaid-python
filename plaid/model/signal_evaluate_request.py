...
class SignalEvaluateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, access_token, account_id, client_transaction_id, amount, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            risk_profile_key (str, none_type): The key of the risk profile to use for this transaction. You can configure a risk profile using the Signal dashboard located within the Plaid Dashboard. If not provided, no risk profile will be used. This feature is currently in closed beta; to request access, contact your account manager.. [optional]  # noqa: E501
        """
