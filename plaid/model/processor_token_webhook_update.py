...
class ProcessorTokenWebhookUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, webhook_type, webhook_code, account_id, new_webhook_url, environment, *args, **kwargs):  # noqa: E501
        """ProcessorTokenWebhookUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, webhook_type, webhook_code, account_id, new_webhook_url, environment, *args, **kwargs):  # noqa: E501
        """ProcessorTokenWebhookUpdate - a model defined in OpenAPI
