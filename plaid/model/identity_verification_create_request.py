...
class IdentityVerificationCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, is_shareable, template_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            user_id (str): A unique user identifier, created by `/user/create`. All integrations that began using `/user/create` after December 10, 2025 use this field to identify a user instead of the `user_token`. For more details, see [new user APIs](https://plaid.com/docs/api/user/user-apis).. [optional]  # noqa: E501
