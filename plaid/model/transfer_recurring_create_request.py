...
class TransferRecurringCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_token, idempotency_key, account_id, type, network, amount, user_present, description, schedule, user, device, *args, **kwargs):  # noqa: E501
