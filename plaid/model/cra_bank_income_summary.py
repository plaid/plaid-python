...
class CraBankIncomeSummary(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            historical_annual_gross_income ([CreditAmountWithCurrency]): An estimate of the annual gross income for the income source, calculated by multiplying the `historical_average_monthly_gross_income` by 12.. [optional]  # noqa: E501
            historical_annual_income ([CreditAmountWithCurrency]): An estimate of the annual net income for the income source, calculated by multiplying the `historical_average_monthly_income` by 12.. [optional]  # noqa: E501
