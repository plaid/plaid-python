...
class CraBankIncomeSummary(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'historical_average_monthly_gross_income': ([CreditAmountWithCurrency],),  # noqa: E501
            'historical_average_monthly_income': ([CreditAmountWithCurrency],),  # noqa: E501
            'forecasted_average_monthly_income': ([CreditAmountWithCurrency],),  # noqa: E501
            'historical_annual_gross_income': ([CreditAmountWithCurrency],),  # noqa: E501
            'historical_annual_income': ([CreditAmountWithCurrency],),  # noqa: E501
            'forecasted_annual_income': ([CreditAmountWithCurrency],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'historical_annual_gross_income': 'historical_annual_gross_income',  # noqa: E501
        'historical_annual_income': 'historical_annual_income',  # noqa: E501
        'forecasted_annual_income': 'forecasted_annual_income',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CraBankIncomeSummary - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            historical_average_monthly_gross_income ([CreditAmountWithCurrency]): An estimate of the average gross monthly income based on the historical net amount and income category for the income source(s).. [optional]  # noqa: E501
            historical_average_monthly_income ([CreditAmountWithCurrency]): The average monthly income amount estimated based on the historical data for the income source(s).. [optional]  # noqa: E501
            forecasted_average_monthly_income ([CreditAmountWithCurrency]): The predicted average monthly income amount for the income source(s).. [optional]  # noqa: E501
            historical_annual_gross_income ([CreditAmountWithCurrency]): An estimate of the annual gross income based on the historical net amount and income category for the income source(s).. [optional]  # noqa: E501
            historical_annual_income ([CreditAmountWithCurrency]): The annual income amount estimated based on the historical data for the income source(s).. [optional]  # noqa: E501
            forecasted_annual_income ([CreditAmountWithCurrency]): The predicted average annual income amount for the income source(s).. [optional]  # noqa: E501
