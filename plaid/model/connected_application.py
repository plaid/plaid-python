...
class ConnectedApplication(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_id, name, created_at, product_data_types, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            logo (str, none_type): A URL that links to the application logo image.. [optional]  # noqa: E501
