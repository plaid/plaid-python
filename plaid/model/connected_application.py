...
class ConnectedApplication(ModelNormal):
    ...
    def _from_openapi_data(cls, application_id, name, created_at, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            created_at (datetime): The date and time this application was linked, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format in UTC (e.g. `\"2020-01-01T00:00:00Z\"`). Note that older, legacy integrations instead receive this value as a date only, in `YYYY-MM-DD` format (e.g. `\"2020-01-01\"`).
