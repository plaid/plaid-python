...
def lazy_import():
    ...
    globals()['TransferCreditFundsSource'] = TransferCreditFundsSource
...
class TransferAuthorizationCreateRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'credit_funds_source': (TransferCreditFundsSource,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, network, amount, user, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            account_id (str): The Plaid `account_id` corresponding to the end-user account that will be debited or credited. Required when creating a transfer using an `access_token`.. [optional]  # noqa: E501
            ...
            credit_funds_source (TransferCreditFundsSource): [optional]  # noqa: E501
            test_clock_id (str, none_type): Plaid’s unique identifier for a test clock. This field may only be used when using `sandbox` environment. If provided, the `authorization` is created at the `virtual_time` on the provided `test_clock`.. [optional]  # noqa: E501
        """
