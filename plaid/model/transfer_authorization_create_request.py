...
class TransferAuthorizationCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, access_token, account_id, type, network, amount, user, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ledger_id (str, none_type): Specify which ledger balance should be used to fund the transfer. You can find a list of `ledger_id`s in the Accounts page of your Plaid Dashboard. If this field is left blank, this will default to id of the default ledger balance.. [optional]  # noqa: E501
            ...
            with_guarantee (bool, none_type): If set to `false`, Plaid will not offer a `guarantee_decision` for this request (Guarantee customers only). This field is deprecated in favor for `guarantee`.. [optional] if omitted the server will use the default value of True  # noqa: E501
            ...
            ruleset_key (str, none_type): The key of the Ruleset for the transaction. This feature is currently in closed beta; to request access, contact your account manager.. [optional]  # noqa: E501
        """
