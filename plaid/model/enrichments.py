...
class Enrichments(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'legacy_category': ([str], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, counterparties, location, logo_url, merchant_name, payment_channel, phone_number, personal_finance_category, personal_finance_category_icon_url, website, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            location (Location):
            logo_url (str, none_type): The URL of a logo associated with this transaction, if available. The logo will always be a 100×100 pixel PNG file.
            ...
            personal_finance_category_icon_url (str): The URL of an icon associated with the primary personal finance category. The icon will always be a 100×100 pixel PNG file.
