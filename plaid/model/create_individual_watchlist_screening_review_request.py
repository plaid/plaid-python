...
def lazy_import():
    ...
    globals()['ReviewComment'] = ReviewComment


class CreateIndividualWatchlistScreeningReviewRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'comment': (ReviewComment,),  # noqa: E501
    ...
    def __init__(self, confirmed_hits, dismissed_hits, watchlist_screening_id, *args, **kwargs):  # noqa: E501
        """CreateIndividualWatchlistScreeningReviewRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (ReviewComment): [optional]  # noqa: E501
