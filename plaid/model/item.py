...
class Item(ModelNormal):
    ...
    def _from_openapi_data(cls, item_id, webhook, error, available_products, billed_products, consent_expiration_time, update_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            consented_products ([Products]): A list of products that have gone through consent collection for the Item. If the session is not enrolled in [Data Transparency Messaging](/docs/link/data-transparency-messaging-migration-guide), this field is not used. . [optional]  # noqa: E501
        """
