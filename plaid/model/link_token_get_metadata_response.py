...
class LinkTokenGetMetadataResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, initial_products, country_codes, language, account_filters, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            client_name (str): The `client_name` specified in the `/link/token/create` call.. [optional]  # noqa: E501
        """
