...
class BaseReportAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balances, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, balances, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
        """BaseReportAccount - a model defined in OpenAPI
