...
class BaseReportAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, account_id, balances, consumer_disputes, mask, metadata, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            transactions ([BaseReportTransaction]): Transaction history associated with the account. Transaction history returned by endpoints such as `/transactions/get` or `/investments/transactions/get` will be returned in the top-level `transactions` field instead.
