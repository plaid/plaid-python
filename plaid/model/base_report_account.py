...
class BaseReportAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, balances, consumer_disputes, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            days_available (float): The duration of transaction history available within this report for this Item, typically defined as the time since the date of the earliest transaction in that account. Only returned by Base Report endpoints.
        ...
        Keyword Args:
            ...
            historical_balances ([BaseReportHistoricalBalance]): Calculated data about the historical balances on the account. Only returned by Base Report endpoints and currently not supported by `brokerage` or `investment` accounts.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, balances, consumer_disputes, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
        """BaseReportAccount - a model defined in OpenAPI
