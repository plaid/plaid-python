...
class BaseReportAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, balances, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            historical_balances ([HistoricalBalance]): Calculated data about the historical balances on the account. Only returned by Base Report endpoints and currently not supported by `brokerage` or `investment` accounts.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, balances, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, *args, **kwargs):  # noqa: E501
        """BaseReportAccount - a model defined in OpenAPI
