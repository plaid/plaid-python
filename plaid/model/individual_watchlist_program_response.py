...
def lazy_import():
    ...
    globals()['IndividualWatchlistScreeningProgramName'] = IndividualWatchlistScreeningProgramName
    globals()['ProgramNameSensitivity'] = ProgramNameSensitivity
    globals()['WatchlistScreeningAuditTrail'] = WatchlistScreeningAuditTrail


class IndividualWatchlistProgramResponse(ModelNormal):
    ...
    def __init__(self, id, created_at, is_rescanning_enabled, lists_enabled, name, name_sensitivity, audit_trail, is_archived, request_id, *args, **kwargs):  # noqa: E501
        """IndividualWatchlistProgramResponse - a model defined in OpenAPI
