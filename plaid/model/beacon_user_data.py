...
class BeaconUserData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date_of_birth, name, address, email_address, phone_number, id_number, ip_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, date_of_birth, name, address, email_address, phone_number, id_number, ip_address, *args, **kwargs):  # noqa: E501
        """BeaconUserData - a model defined in OpenAPI
