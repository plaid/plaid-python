...
class CraBankIncomeItem(ModelNormal):
    ...
    def _from_openapi_data(cls, bank_income_accounts, bank_income_sources, *args, **kwargs):  # noqa: E501
        ...
        Args:
            bank_income_accounts ([CraBankIncomeAccount]): The Item's accounts that have bank income data.
            bank_income_sources ([CraBankIncomeSource]): The income sources for this Item. Each entry in the array is a single income source.
