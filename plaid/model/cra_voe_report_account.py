...
def lazy_import():
    ...
    globals()['CraVoeReportTransaction'] = CraVoeReportTransaction


class CraVoeReportAccount(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'transactions': ([CraVoeReportTransaction],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, account_id, name, official_name, type, subtype, transactions, *args, **kwargs):  # noqa: E501
        """CraVoeReportAccount - a model defined in OpenAPI
        ...
        Args:
            ...
            transactions ([CraVoeReportTransaction]): Transaction history associated with the account for the VOE Report. Note that this transaction differs from a Base Report transaction in that it will only be deposits, and the amounts will be omitted.
