...
class PaymentInitiationConsent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, consent_id, status, created_at, recipient_id, reference, constraints, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, consent_id, status, created_at, recipient_id, reference, constraints, *args, **kwargs):  # noqa: E501
        """PaymentInitiationConsent - a model defined in OpenAPI
