...
def lazy_import():
    ...
    globals()['PaymentInitiationConsentPayerDetails'] = PaymentInitiationConsentPayerDetails
...
class PaymentInitiationConsentCreateRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'payer_details': (PaymentInitiationConsentPayerDetails,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, recipient_id, reference, constraints, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            user_id (str): The `user_id` of the end user the payment consent is for, as returned by [`/user/create`](https://plaid.com/docs/api/users/#usercreate). The user must have a `name` and either an email address or a phone number. Payments created from this consent inherit this `user_id`. Required for new integrations.. [optional]  # noqa: E501
            scopes ([PaymentInitiationConsentScope]): An array of payment consent scopes.. [optional]  # noqa: E501
            type (PaymentInitiationConsentType): [optional]  # noqa: E501
            options (ExternalPaymentInitiationConsentOptions): [optional]  # noqa: E501
            payer_details (PaymentInitiationConsentPayerDetails): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, recipient_id, reference, constraints, *args, **kwargs):  # noqa: E501
        """PaymentInitiationConsentCreateRequest - a model defined in OpenAPI
