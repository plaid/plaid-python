...
class LinkTokenCreateRequestIncomeVerificationBankIncome(ModelNormal):
    ...
    def _from_openapi_data(cls, days_requested, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enable_multiple_items (bool, none_type): Whether to enable multiple Items to be added in the Link session. This setting is deprecated and has been replaced by the more general `enable_multi_item_link` setting, which supports all products.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
