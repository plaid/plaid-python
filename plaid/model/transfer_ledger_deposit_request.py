...
class TransferLedgerDepositRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, idempotency_key, network, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ledger_id (str, none_type): Specify which ledger balance to deposit to. Customers can find a list of `ledger_id`s in the Accounts page of your Plaid Dashboard. If this field is left blank, this will default to id of the default ledger balance.. [optional]  # noqa: E501
