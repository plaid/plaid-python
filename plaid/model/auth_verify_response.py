...
class AuthVerifyResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, verification_status, verification_insights, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            item_id (str, none_type): The `item_id` value of the Item created for verification. If numbers data provided is invalid, an item may not be created.. [optional]  # noqa: E501
        """
        ...
        self.verification_insights = verification_insights
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, verification_status, verification_insights, *args, **kwargs):  # noqa: E501
        """AuthVerifyResponse - a model defined in OpenAPI
