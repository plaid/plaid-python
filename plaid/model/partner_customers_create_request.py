...
class PartnerCustomersCreateRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_name, is_diligence_attested, products, *args, **kwargs):  # noqa: E501
        """PartnerCustomersCreateRequest - a model defined in OpenAPI
        ...
        Args:
            ...
            products ([Products]): The products to be enabled on for the end customer.
        ...
        Keyword Args:
            ...
            create_link_customization (bool): If true, sets end customer's link customization to match partner's link customization.. [optional]  # noqa: E501
        """
