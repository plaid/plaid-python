...
def lazy_import():
    ...
    globals()['CashflowReportPaymentMeta'] = CashflowReportPaymentMeta
...
class CashflowReportTransaction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'payment_meta': (CashflowReportPaymentMeta,),  # noqa: E501
            'pending': (bool, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, account_id, amount, iso_currency_code, unofficial_currency_code, date, location, name, payment_meta, pending, pending_transaction_id, account_owner, transaction_id, authorized_date, authorized_datetime, datetime, payment_channel, transaction_code, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            pending (bool, none_type): When `true`, identifies the transaction as pending or unsettled. Pending transaction details (name, type, amount, category ID) may change before they are settled. Not all institutions provide pending transactions.
        ...
        Keyword Args:
            ...
            personal_finance_category_icon_url (str, none_type): The URL of an icon associated with the primary personal finance category. The icon will always be a 100×100 pixel PNG file.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, iso_currency_code, unofficial_currency_code, date, location, name, payment_meta, pending, pending_transaction_id, account_owner, transaction_id, authorized_date, authorized_datetime, datetime, payment_channel, transaction_code, *args, **kwargs):  # noqa: E501
        """CashflowReportTransaction - a model defined in OpenAPI
