...
class CreditCardLiability(ModelNormal):
    ...
    def __init__(self, account_id, aprs, is_overdue, last_payment_amount, last_payment_date, last_statement_issue_date, minimum_payment_amount, next_payment_due_date, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            last_payment_date (date): The date of the last payment. Dates are returned in an ISO 8601 format (YYYY-MM-DD). Availability for this field is limited.
            last_statement_issue_date (date): The date of the last statement. Dates are returned in an ISO 8601 format (YYYY-MM-DD).
