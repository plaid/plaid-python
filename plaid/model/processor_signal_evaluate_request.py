...
class ProcessorSignalEvaluateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, processor_token, client_transaction_id, amount, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ruleset_key (str, none_type): The key of the Ruleset to use for this transaction. You can configure a Ruleset using the Signal dashboard located within the Plaid Dashboard. If not provided, no Ruleset will be used. This feature is currently in closed beta; to request access, contact your account manager.. [optional]  # noqa: E501
        """
