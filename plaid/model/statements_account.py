...
class StatementsAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, account_name, account_type, statements, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, account_name, account_type, statements, *args, **kwargs):  # noqa: E501
        """StatementsAccount - a model defined in OpenAPI
