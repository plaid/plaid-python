...
def lazy_import():
    ...
    from plaid.model.pay_stub_deductions import PayStubDeductions
    from plaid.model.pay_stub_earnings import PayStubEarnings
    from plaid.model.pay_stub_employee import PayStubEmployee
    from plaid.model.pay_stub_employer import PayStubEmployer
    from plaid.model.pay_stub_net_pay import PayStubNetPay
    from plaid.model.pay_stub_pay_period_details import PayStubPayPeriodDetails
    from plaid.model.pay_stub_verification import PayStubVerification
    globals()['CreditDocumentMetadata'] = CreditDocumentMetadata
    globals()['PayStubDeductions'] = PayStubDeductions
    globals()['PayStubEarnings'] = PayStubEarnings
    globals()['PayStubEmployee'] = PayStubEmployee
    globals()['PayStubEmployer'] = PayStubEmployer
    globals()['PayStubNetPay'] = PayStubNetPay
...
class PayStub(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, deductions, document_id, document_metadata, earnings, employee, employer, net_pay, pay_period_details, verification, *args, **kwargs):  # noqa: E501
