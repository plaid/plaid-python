...
class CreditFreddieMacAssetDetailVOE25(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset_unique_identifier, asset_account_identifier, asset_as_of_date, asset_description, asset_type, asset_type_additional_description, asset_days_requested_count, asset_ownership_type, *args, **kwargs):  # noqa: E501
        """CreditFreddieMacAssetDetailVOE25 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_unique_identifier, asset_account_identifier, asset_as_of_date, asset_description, asset_type, asset_type_additional_description, asset_days_requested_count, asset_ownership_type, *args, **kwargs):  # noqa: E501
        """CreditFreddieMacAssetDetailVOE25 - a model defined in OpenAPI
