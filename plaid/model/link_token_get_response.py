...
def lazy_import():
    ...
    globals()['LinkTokenGetMetadataResponse'] = LinkTokenGetMetadataResponse
    globals()['LinkTokenGetSessionsResponse'] = LinkTokenGetSessionsResponse
...
class LinkTokenGetResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'link_sessions': ([LinkTokenGetSessionsResponse],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'link_sessions': 'link_sessions',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, link_token, created_at, expiration, metadata, request_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            link_sessions ([LinkTokenGetSessionsResponse]): Information about Link sessions created using this `link_token`. This field will only be present if your client is enabled for Hosted Link (beta). Session data will be provided for up to six hours after the session has ended.. [optional]  # noqa: E501
        """
