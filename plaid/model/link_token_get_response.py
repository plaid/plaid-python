...
class LinkTokenGetResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, link_token, created_at, expiration, metadata, request_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            link_sessions ([LinkTokenGetSessionsResponse]): Information about Link sessions created using this `link_token`. Session data will be provided for up to six hours after the session has ended.. [optional]  # noqa: E501
