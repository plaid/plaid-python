...
class CraCheckReportCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, user_token, webhook, days_requested, consumer_report_permissible_purpose, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            days_requested (int): The number of days of data to request for the report. If requesting Income Insights, a minimum of 90 days is recommended in order to receive both historical and forecasted income.
