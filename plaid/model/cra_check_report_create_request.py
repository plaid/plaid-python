...
def lazy_import():
    ...
    globals()['CraCheckReportProduct'] = CraCheckReportProduct
...
class CraCheckReportCreateRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'products': ([CraCheckReportProduct],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_token, webhook, consumer_report_permissible_purpose, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            days_requested (int): The number of days of data to request for the report. [optional]  # noqa: E501
            products ([CraCheckReportProduct]): Products that will be retrieved in this report. This configuration will determine what data types to fetch from the user's financial institution. If omitted, the data types needed to support all products will be fetched.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_token, webhook, consumer_report_permissible_purpose, *args, **kwargs):  # noqa: E501
        """CraCheckReportCreateRequest - a model defined in OpenAPI
