...
class CraCheckReportCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, user_token, webhook, days_requested, consumer_report_permissible_purpose, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            products ([Products], none_type): Specifies a list of products that will be eagerly generated when creating the report. These products will be made available before a success webhook is sent. Use this option to minimize response latency for product `/get` endpoints.. [optional]  # noqa: E501
