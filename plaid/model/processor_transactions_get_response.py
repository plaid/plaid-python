...
class ProcessorTransactionsGetResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account, transactions, total_transactions, request_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account, transactions, total_transactions, request_id, *args, **kwargs):  # noqa: E501
        """ProcessorTransactionsGetResponse - a model defined in OpenAPI
