...
def lazy_import():
    ...
    globals()['StatementsAccount'] = StatementsAccount


class StatementsListResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'accounts': ([StatementsAccount],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, accounts, institution_id, institution_name, item_id, request_id, *args, **kwargs):  # noqa: E501
        """StatementsListResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, institution_id, institution_name, item_id, request_id, *args, **kwargs):  # noqa: E501
        """StatementsListResponse - a model defined in OpenAPI
