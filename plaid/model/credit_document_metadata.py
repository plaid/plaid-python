...
class CreditDocumentMetadata(ModelNormal):
    ...
    def _from_openapi_data(cls, name, document_type, download_url, status, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            download_url (str, none_type): Signed URL to retrieve the underlying file. This download URL can only be used once. To generate a new download URL, call `/credit/payroll_income/get` again.
            status (str, none_type): The processing status of the document.
