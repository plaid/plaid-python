...
class InvestmentTransaction(ModelNormal):
    ...
    def _from_openapi_data(cls, investment_transaction_id, account_id, security_id, date, name, quantity, amount, price, fees, type, subtype, iso_currency_code, unofficial_currency_code, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            transaction_datetime (datetime, none_type): Timestamp in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:mm:ssZ`) representing when the order type was initiated. This field is returned for select financial institutions and reflects the value provided by the institution.. [optional]  # noqa: E501
        """
