...
class CraBankIncomeSource(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'next_payment_date': (date,),  # noqa: E501
            'historical_average_monthly_gross_income': (float,),  # noqa: E501
            'historical_average_monthly_income': (float,),  # noqa: E501
            'forcasted_average_monthly_income': (float,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'forcasted_average_monthly_income': 'forcasted_average_monthly_income',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            next_payment_date (date): The expected date of the end user’s next paycheck for the income source. The date will be returned in an ISO 8601 format (YYYY-MM-DD).. [optional]  # noqa: E501
            historical_average_monthly_gross_income (float): An estimate of the average gross monthly income based on the historical net amount and income category for the income source(s).. [optional]  # noqa: E501
            historical_average_monthly_income (float): The average monthly net income amount estimated based on the historical data for the income source(s).. [optional]  # noqa: E501
            forcasted_average_monthly_income (float): The predicted average monthly net income amount for the income source(s).. [optional]  # noqa: E501
