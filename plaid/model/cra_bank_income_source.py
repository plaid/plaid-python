...
class CraBankIncomeSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, forecasted_average_monthly_income_prediction_intervals, income_provider, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            income_source_id (str): A unique identifier for an income source. If the report is regenerated and a new `report_id` is created, the new report will have a new set of `income_source_id`s.. [optional]  # noqa: E501
            ...
            status (CraBankIncomeStatus): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, forecasted_average_monthly_income_prediction_intervals, income_provider, *args, **kwargs):  # noqa: E501
        """CraBankIncomeSource - a model defined in OpenAPI
