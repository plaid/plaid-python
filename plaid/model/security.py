...
def lazy_import():
    ...
    globals()['FixedIncome'] = FixedIncome
...
class Security(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'figi': (str, none_type,),  # noqa: E501
            'option_contract': (OptionContract,),  # noqa: E501
            'fixed_income': (FixedIncome,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'cfi_code': 'cfi_code',  # noqa: E501
        'figi': 'figi',  # noqa: E501
        'option_contract': 'option_contract',  # noqa: E501
        'fixed_income': 'fixed_income',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, security_id, isin, cusip, sedol, institution_security_id, institution_id, proxy_security_id, name, ticker_symbol, is_cash_equivalent, type, close_price, close_price_as_of, iso_currency_code, unofficial_currency_code, market_identifier_code, sector, industry, cfi_code, figi, option_contract, fixed_income, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            sedol (str, none_type): (Deprecated) 7-character SEDOL, an identifier assigned to securities in the UK.
            ...
            cfi_code (str, none_type): The ISO-10962 Classification of Financial Instruments Code used to classify the security based on its structure and function.
            figi (str, none_type): 12-character FIGI, a unique Financial Instrument Global Identifier assigned to securities that is immutable and stays consistent across most corporate actions. This is an open data standard issued by the Object Management Group and administered by Bloomberg L.P.
    ...
    @convert_js_args_to_python_args
    def __init__(self, security_id, isin, cusip, sedol, institution_security_id, institution_id, proxy_security_id, name, ticker_symbol, is_cash_equivalent, type, close_price, close_price_as_of, iso_currency_code, unofficial_currency_code, market_identifier_code, sector, industry, cfi_code, figi, option_contract, fixed_income, *args, **kwargs):  # noqa: E501
        """Security - a model defined in OpenAPI
