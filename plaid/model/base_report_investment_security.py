...
class BaseReportInvestmentSecurity(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, security_id, name, isin, cusip, institution_security_id, institution_id, ticker_symbol, type, *args, **kwargs):  # noqa: E501
        """BaseReportInvestmentSecurity - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, security_id, name, isin, cusip, institution_security_id, institution_id, ticker_symbol, type, *args, **kwargs):  # noqa: E501
        """BaseReportInvestmentSecurity - a model defined in OpenAPI
