...
class PhysicalDocumentExtractedData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id_number, category, expiration_date, issuing_country, issuing_region, date_of_birth, address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id_number, category, expiration_date, issuing_country, issuing_region, date_of_birth, address, *args, **kwargs):  # noqa: E501
        """PhysicalDocumentExtractedData - a model defined in OpenAPI
