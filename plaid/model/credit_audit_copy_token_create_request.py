...
class CreditAuditCopyTokenCreateRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tokens, auditor_id, *args, **kwargs):  # noqa: E501
        """CreditAuditCopyTokenCreateRequest - a model defined in OpenAPI

        Args:
            tokens ([str]): List of report tokens; can include both Asset Report tokens and Income Report tokens.
