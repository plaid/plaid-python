...
class TransactionsSyncRequestOptions(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            days_requested (int): If Transactions has not already been added to the Item, this option controls the maximum number of days of transaction history Plaid will request from the financial institution. If Transactions has already been added to the Item, this field will have no effect.. [optional] if omitted the server will use the default value of 90  # noqa: E501
        """
