...
def lazy_import():
    ...
    globals()['EntityWatchlistScreeningProgramName'] = EntityWatchlistScreeningProgramName
    globals()['ProgramNameSensitivity'] = ProgramNameSensitivity
    globals()['WatchlistScreeningAuditTrail'] = WatchlistScreeningAuditTrail


class EntityWatchlistProgram(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (EntityWatchlistScreeningProgramName,),  # noqa: E501
    ...
    def __init__(self, id, created_at, enabled, lists_enabled, name, name_sensitivity, audit_trail, archived, *args, **kwargs):  # noqa: E501
        """EntityWatchlistProgram - a model defined in OpenAPI

        Args:
            id (str): ID of the associated entity program.
            created_at (datetime): An ISO8601 formatted timestamp.
            enabled (bool): Indicator specifying whether the program is enabled and can be used to screen entities.
