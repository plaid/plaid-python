...
class PaymentInitiationRefund(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, refund_id, amount, status, last_status_update, *args, **kwargs):  # noqa: E501
        """PaymentInitiationRefund - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, refund_id, amount, status, last_status_update, *args, **kwargs):  # noqa: E501
        """PaymentInitiationRefund - a model defined in OpenAPI
