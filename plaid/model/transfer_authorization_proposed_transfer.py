...
class TransferAuthorizationProposedTransfer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'requested_amount': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, funding_account_id, type, user, amount, requested_amount, network, origination_account_id, iso_currency_code, originator_client_id, credit_funds_source, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            requested_amount (str): The amount originally requested by the client when creating the authorization (decimal string with two digits of precision e.g. \"800.00\"). This may differ from `amount`, the amount Plaid proposes to transfer, when only a partial amount is offered as part of an Adaptive Guarantee.
    ...
    @convert_js_args_to_python_args
    def __init__(self, funding_account_id, type, user, amount, requested_amount, network, origination_account_id, iso_currency_code, originator_client_id, credit_funds_source, *args, **kwargs):  # noqa: E501
        """TransferAuthorizationProposedTransfer - a model defined in OpenAPI
