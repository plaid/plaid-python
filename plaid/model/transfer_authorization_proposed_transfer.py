...
class TransferAuthorizationProposedTransfer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, funding_account_id, type, user, amount, network, origination_account_id, iso_currency_code, originator_client_id, *args, **kwargs):  # noqa: E501
