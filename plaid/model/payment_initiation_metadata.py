...
class PaymentInitiationMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, supports_international_payments, maximum_payment_amount, supports_refund_details, standing_order_metadata, *args, **kwargs):  # noqa: E501
