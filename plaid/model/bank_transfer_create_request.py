...
class BankTransferCreateRequest(ModelNormal):
    ...
    def __init__(self, idempotency_key, access_token, account_id, type, network, amount, iso_currency_code, description, user, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            custom_tag (str): An arbitrary string provided by the client for storage with the bank transfer. Will be returned in all `BankTransfer` objects. May be up to 100 characters.. [optional]  # noqa: E501
            metadata (BankTransferMetadata): [optional]  # noqa: E501
            origination_account_id (str): Plaid’s unique identifier for the origination account for this transfer. If you have more than one origination account, this value must be specified.. [optional]  # noqa: E501
        """
