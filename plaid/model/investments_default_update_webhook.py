...
class InvestmentsDefaultUpdateWebhook(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, webhook_type, webhook_code, item_id, new_investments_transactions, canceled_investments_transactions, environment, *args, **kwargs):  # noqa: E501
