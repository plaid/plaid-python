...
class CraBankIncomeAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mask, name, official_name, subtype, type, owners, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, mask, name, official_name, subtype, type, owners, *args, **kwargs):  # noqa: E501
        """CraBankIncomeAccount - a model defined in OpenAPI
