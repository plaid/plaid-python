...
class BalancePlusAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, unauthorized_transactions_count_7d, unauthorized_transactions_count_30d, unauthorized_transactions_count_60d, unauthorized_transactions_count_90d, nsf_overdraft_transactions_count_7d, nsf_overdraft_transactions_count_30d, nsf_overdraft_transactions_count_60d, nsf_overdraft_transactions_count_90d, days_since_first_plaid_connection, plaid_connections_count_7d, plaid_connections_count_30d, total_plaid_connections_count, is_savings_or_money_market_account, phone_change_count_28d, phone_change_count_90d, email_change_count_28d, email_change_count_90d, address_change_count_28d, address_change_count_90d, plaid_non_oauth_authentication_attempts_count_3d, plaid_non_oauth_authentication_attempts_count_7d, plaid_non_oauth_authentication_attempts_count_30d, failed_plaid_non_oauth_authentication_attempts_count_3d, failed_plaid_non_oauth_authentication_attempts_count_7d, failed_plaid_non_oauth_authentication_attempts_count_30d, is_account_closed, is_account_frozen_or_restricted, *args, **kwargs):  # noqa: E501
        """BalancePlusAttributes - a model defined in OpenAPI

        Args:
            unauthorized_transactions_count_7d (int, none_type): The number of possible past returns due to unauthorized transactions over the past 7 days from the account that will be debited
            unauthorized_transactions_count_30d (int, none_type): The number of possible past returns due to unauthorized transactions over the past 30 days from the account that will be debited
            unauthorized_transactions_count_60d (int, none_type): The number of possible past returns due to unauthorized transactions over the past 60 days from the account that will be debited
            unauthorized_transactions_count_90d (int, none_type): The number of possible past returns due to unauthorized transactions over the past 90 days from the account that will be debited
            nsf_overdraft_transactions_count_7d (int, none_type): The number of possible past returns due to non-sufficient funds/overdrafts over the past 7 days from the account that will be debited
            nsf_overdraft_transactions_count_30d (int, none_type): The number of possible past returns due to non-sufficient funds/overdrafts over the past 30 days from the account that will be debited
            nsf_overdraft_transactions_count_60d (int, none_type): The number of possible past returns due to non-sufficient funds/overdrafts over the past 60 days from the account that will be debited
            nsf_overdraft_transactions_count_90d (int, none_type): The number of possible past returns due to non-sufficient funds/overdrafts over the past 90 days from the account that will be debited
            ...
            is_savings_or_money_market_account (bool, none_type): Indicates if the ACH transaction funding account is a savings/money market account
            ...
            is_account_closed (bool, none_type): Indicates if the receiver bank account is closed
            is_account_frozen_or_restricted (bool, none_type): Indicates if the receiver bank account is either frozen or restricted
