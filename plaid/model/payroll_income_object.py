...
class PayrollIncomeObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, pay_stubs, w2s, form1099s, i20s, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            i20s ([CreditI20]): Array of Form I-20 US immigration student documents.
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, pay_stubs, w2s, form1099s, i20s, *args, **kwargs):  # noqa: E501
        """PayrollIncomeObject - a model defined in OpenAPI
