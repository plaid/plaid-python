...
class TransferIntentGet(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created, status, transfer_id, failure_reason, authorization_decision, authorization_decision_rationale, origination_account_id, amount, mode, ach_class, user, description, iso_currency_code, *args, **kwargs):  # noqa: E501
