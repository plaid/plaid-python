...
class CreditBankStatementUploadTransaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, date, original_description, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, date, original_description, *args, **kwargs):  # noqa: E501
        """CreditBankStatementUploadTransaction - a model defined in OpenAPI
