...
class LinkTokenCreateRequestUser(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'phone_number_verified_time': (str,),  # noqa: E501
    ...
    def __init__(self, client_user_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            legal_name (str): The user's full legal name. This is an optional field used in the [returning user experience](/docs/link/returning-user) to associate Items to the user.. [optional]  # noqa: E501
            phone_number (str): The user's phone number in [E.164](https://en.wikipedia.org/wiki/E.164) format. This field is optional, but required to enable the [returning user experience](/docs/link/returning-user).. [optional]  # noqa: E501
