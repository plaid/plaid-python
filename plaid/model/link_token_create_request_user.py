...
class LinkTokenCreateRequestUser(ModelNormal):
    ...
    def _from_openapi_data(cls, client_user_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            phone_number (str): The user's phone number in [E.164](https://en.wikipedia.org/wiki/E.164) format. This field is optional, but required to enable the [returning user experience](https://plaid.com/docs/link/returning-user). Can also be used to prefill Link fields when used with Identity Verification.. [optional]  # noqa: E501
            ...
            email_address (str): The user's email address. This field is optional, but required to enable the [pre-authenticated returning user flow](https://plaid.com/docs/link/returning-user/#pre-authenticated-rux). Can also be used to prefill Link fields when used with Identity Verification.. [optional]  # noqa: E501
