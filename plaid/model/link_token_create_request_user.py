...
class LinkTokenCreateRequestUser(ModelNormal):
    ...
    def _from_openapi_data(cls, client_user_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            email_address (str): The user's email address. This field is optional, but required to enable the [pre-authenticated returning user flow](https://plaid.com/docs/link/returning-user/#pre-authenticated-rux).. [optional]  # noqa: E501
