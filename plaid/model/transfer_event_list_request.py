...
class TransferEventListRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TransferEventListRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_date (datetime, none_type): The start datetime of transfers to list. This should be in RFC 3339 format (i.e. `2019-12-06T22:35:49Z`). [optional]  # noqa: E501
            ...
            funding_account_id (str, none_type): Filter transfer events to only those with the specified `funding_account_id`.. [optional]  # noqa: E501
        """
