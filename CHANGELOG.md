...
# 38.4.0
- Updating to OAS 2020-09-14_1.682.1
...
- Converts some integers that were incorrectly typed as `float` to `ints`. For more details, see the changelog notes for 2020-09-14_1.349.0.
...
- We updated the OpenAPI generator used for this version from v5.1.0 to v6.1.0. You can view the changelog for this update at [OpenAPITools/openapi-generator/releases](https://github.com/OpenAPITools/openapi-generator/releases)

## Breaking Changes in this version

This version does not contain any breaking changes.
...
The official release of the `plaid-python` generated library. See the [migration guide](https://github.com/plaid/plaid-python#migration-guide) for instructions on migrating to this version.
